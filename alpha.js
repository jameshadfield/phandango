...
function tree_stuff() {
  ...
  phylocanvas.on('loaded', function(){
    drawGubbinsBlocks(canvas, ctx);
  })
  phylocanvas.on('mousewheel', function(){
    drawGubbinsBlocks(canvas, ctx);
    console.log(phylocanvas.canvas, phylocanvas.offsety)

  })
  phylocanvas.on('mousemove', function(e){
    drawGubbinsBlocks(canvas, ctx);
  })
...
function drawGubbinsBlocks(thiscanvas,ctx) {
...
function init() {
  ...
  // setInterval( function() {drawGubbinsBlocks(canvas,ctx); },INTERVAL)
