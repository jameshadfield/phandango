...
const examples = [
  ...
  {
    name: 'PMEN1 (bratNextGen)',
    imgPath: 'img/bratNextGen.png',
    caption: 'The same dataset as in the previous example but using bratNextGen to infer recombination blocks instead of gubbins. The phylogeny is the one generated by gubbins.',
    paths: [
      defaultDataPrefix + 'v0.2.0/example_datasets/gubbins/Spn23f.gff',
      defaultDataPrefix + 'v0.2.0/example_datasets/gubbins/gubbins.tre',
      defaultDataPrefix + 'v0.2.0/example_datasets/gubbins/meta.simple.csv',
  ...
  {
    name: 'PMEN1 (compare gubbins & bratNextGen)',
    imgPath: 'img/merge.png',
    caption: 'A comparison of the two previous examples - the inferred recombination blocks from both gubbins and bratNextGen compared in real time for the PMEN1 Strep Pneumo dataset. Hint: go to the settings page (press s or use the menu at the top of the page) to toggle between algorithms or use the shortcut keys z, x, c & v.',
    paths: [
      defaultDataPrefix + 'v0.2.0/example_datasets/gubbins/Spn23f.gff',
      defaultDataPrefix + 'v0.2.0/example_datasets/gubbins/gubbins.gff',
      defaultDataPrefix + 'v0.2.0/example_datasets/gubbins/gubbins.tre',
